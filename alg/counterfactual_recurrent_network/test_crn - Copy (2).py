...
def init_arg():
    ...
    parser.add_argument("--chemo_dosage_coeff", default=1, type=int)
    parser.add_argument("--radio_dosage_coeff", default=1, type=int)
...
if __name__ == '__main__':
    ...
    if args.treatment_format == 'one_hot':
    ...
    elif args.treatment_format == 'continuous':
